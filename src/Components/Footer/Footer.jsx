...
const Footer = () => {
    return (
        <div>
            ...
            <footer className="footer footer-center p-10 bg-[#d8f3dc] text-base-content rounded">
                ...
                <aside>
                    <p className="font-medium text-[#2d6a4f]">Copyright © 2023 - All right reserved by TaskGrid</p>
                </aside>
            </footer>
